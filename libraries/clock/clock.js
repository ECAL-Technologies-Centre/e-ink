...
const Clock = (function() {
    ...
    const o = {
            date: new Date(),
            trueTime: false,
            fontSrc: 'https://rawcdn.githack.com/ECAL-Technologies-Centre/e-ink/fe0b0555cea3f1b4ef5bd803d1e186b6b84f6dbf/libraries/clock/rsrc/font.png'
        },
        dom = {};
    ...
    window.addEventListener('load', function() {
        ...
        dom.clock.addEventListener('mouseup', function(e) {
            ...
            if (!MOUSE.valueChanged && MOUSE.pressTarg === e.target && e.target.tagName === 'INPUT') {
                e.target.value = '';
            } else {
        ...
        document.addEventListener('keydown', function(e) {
            switch (e.key) {
                ...
                case 'Tab':
                    ...
                    if (!dom.display.contains(e.target))
                        return;
    ...
    const handler = {
        ...
        _time: { Hour: o.date.getHours(), Minute: o.date.getMinutes(), Second: o.date.getSeconds() },

        fontDims: { ":": [0, 2], 0: [1, 6], 1: [2, 6], 2: [3, 6], 3: [4, 6], 4: [6, 6], 5: [6, 6], 6: [7, 6], 7: [7, 6], 8: [9, 6], 9: [10, 6] },
        ...
        customMethods: {
            ...
            display(options) {
                ...
                for (let i = 0; i < text.length; i++) {
                    ...
                    c.drawImage(this.fontImg, map[0] * width, 0, width, height, space, 0, width, height);
        ...
        compare() {
            for (let key in this._time) {
                ...
                if (value !== this._time[key]) {
                    ...
                    this.customMethods[`on${key}Change`].call(this.date, { value: value });
                }
            }
        },
